...
class CategoryPolicy
{
    ...
    {
        if ($user->canDo('portfolio.category.view') && $user->isAdmin()) {
            return true;
        }
    ...
    {
        if ($user->canDo('portfolio.category.edit') && $user->isAdmin()) {
            return true;
        }
    ...
    {
        if ($user->canDo('portfolio.category.verify')) {
            return true;
        }
    ...
    {
        if ($user->canDo('portfolio.category.approve')) {
            return true;
        }
